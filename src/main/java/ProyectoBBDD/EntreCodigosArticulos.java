 ...
 * @author alumno
 */
public class EntreCodigosArticulos extends javax.swing.JFrame {

    /**
     * Creates new form EntreCodigos
     */
    public EntreCodigosArticulos() {
        initComponents();
    }
    ...
    public void generarIReport() {
        ...
        try {
            ...
            Logger.getLogger(EntreCodigosArticulos.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EntreCodigosArticulos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
